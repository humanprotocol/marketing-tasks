  ...
  describe('transformKeysFromSnakeToCamel', () => {
    describe('succeed', () => {
      it.each([
        ...
        expect(CaseConverter.transformKeysFromSnakeToCamel(value)).toEqual(
          value,
        );
      });
      ...
      it('should transform array of objects', () => {
        ...
        const expectedOutput = input.map((v: any) => ({
  ...
  describe('transformKeysFromCamelToSnake', () => {
    describe('succeed', () => {
      it.each([
        ...
        expect(CaseConverter.transformKeysFromCamelToSnake(value)).toEqual(
          value,
        );
      });
